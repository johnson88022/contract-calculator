        ...
        history.forEach(function(record, index) {
            ...
            const summaryEdit = `
                        <div class="row-edit" style="padding: 10px; background: #f0f9ff; border-radius: 8px; border: 1px solid #bae6fd;">
                            ...
                            <div>進場價: <input class="inline-edit" type="number" step="0.01" value="${record.entry}" data-k="entry" data-i="${index}"> | 止損價: <input class="inline-edit" type="number" step="0.01" value="${record.stop}" data-k="stop" data-i="${index}"></div>
                            <div>最大虧損: <input class="inline-edit" type="number" step="0.01" value="${record.maxLoss}" data-k="maxLoss" data-i="${index}"> U</div>
